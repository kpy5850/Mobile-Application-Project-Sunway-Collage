...
public class Flareon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backgroundMusic.start(this, R.raw.flareon_music, true);
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Flareon.this, Pop_Setting.class);
                startActivityForResult(intent, 1);
            }
        });

        //GIF Image: Snow_Drop
        ImageView imageview = findViewById(R.id.Musics);

        Glide.with(this)
                .asGif()
                .load(R.raw.music_symbols)
                .into(imageview);

        ImageView imageview2 = findViewById(R.id.Flareon);
        ...
        btnClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(CurrentProgressBar == 10) {
                    Intent intent = new Intent(Flareon.this, Complete_Window.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK && data != null) {
            ...
            if ("reset".equals(action)) {
                Intent intent = new Intent(Flareon.this, Eevee.class);
